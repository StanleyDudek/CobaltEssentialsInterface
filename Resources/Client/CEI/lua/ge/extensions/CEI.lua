            ...
            for k in pairs(players) do
                ...
                if im.CollapsingHeader1(players[k].playerName) then
                    ...
                    if currentGroup == "owner" or currentGroup == "admin" or currentGroup == "mod" or currentUIPerm >= config.cobalt.interface.playerPermissions then
                        ...
                        im.Text("Reason:")
                        im.SameLine()
                        im.InputText("##"..tostring(k), playersVals[k].kickBanMuteReason, 128)
                    end
                    if currentGroup == "owner" or currentGroup == "admin" or currentUIPerm >= config.cobalt.interface.playerPermissionsPlus then
                        im.Text("        ")
                        im.SameLine()
                    ...
                    if vehiclesCounter > 0 then
                        ...
                        if im.TreeNode1("vehicles:##"..tostring(k)) then
                            ...
                            if currentGroup == "owner" or currentGroup == "admin" or currentGroup == "mod" or currentUIPerm >= config.cobalt.interface.playerPermissions then
                                ...
                                im.Text("Reason:")
                                im.SameLine()
                                im.InputText("##vehReason"..tostring(k), playersVals[k].vehDeleteReason, 128)
                            end
                            for x in pairs(players[k].vehicles) do
                            ...
                            if im.TreeNode1("permissions##"..tostring(k)) then
                                ...
                                if im.TreeNode1("group:##"..tostring(k)) then
                                    ...
                                    if currentGroup == "owner" or currentGroup == "admin" or currentUIPerm >= config.cobalt.interface.playerPermissionsPlus then
                                        im.Text("        ")
                                        im.SameLine()
                                        im.InputText("##newGroup"..tostring(k), playersVals[k].permissions.groupInput, 128)
                                        im.Text("        ")
                                        im.SameLine()
                    ...
                    if im.CollapsingHeader1("Cobalt Essentials") then
                        ...
                        if currentGroup == "owner" or currentGroup == "admin" or currentUIPerm >= config.cobalt.interface.config then
                            ...
                            if im.TreeNode1("spawnVehicles:") then
                                ...
                                im.SameLine()
                                im.PushItemWidth(120*CEIScale[0])
                                im.InputText("##newSpawnLevel", configVals.cobalt.permissions.newSpawnVehiclesLevelInput, 128)
                                im.PopItemWidth()
                                im.Text("        ")
                                im.SameLine()
                            ...
                            if im.TreeNode1("sendMessage:") then
                                ...
                                im.SameLine()
                                im.PushItemWidth(120*CEIScale[0])
                                im.InputText("##newSendMessageLevel", configVals.cobalt.permissions.newSendMessageLevelInput, 128)
                                im.PopItemWidth()
                                im.Text("        ")
                                im.SameLine()
                            ...
                            if im.TreeNode1("vehicleCaps:") then
                                ...
                                im.SameLine()
                                im.PushItemWidth(120*CEIScale[0])
                                im.InputText("##newLevel", configVals.cobalt.permissions.newLevelInput, 128)
                                im.PopItemWidth()
                                im.Text("        ")
                                im.SameLine()
                            ...
                            if im.TreeNode1("vehiclePerms:") then
                                ...
                                im.Text("    Add vehicle: ")
                                im.SameLine()
                                im.InputText("##newVehicle", configVals.cobalt.permissions.newVehicleInput, 128)
                                im.Text("    ")
                                im.SameLine()
                                        ...
                                        if im.ImGuiTextFilter_PassFilter(vehiclePermsFiltering.filter, vehiclePermsFiltering.lines[i]) then
                                            if config.cobalt.permissions.vehiclePerm[k].name == vehiclePermsFiltering.lines[i] then
                                                if im.TreeNode1(vehiclePermsFiltering.lines[i] .. ":") then
                                                    ...
                                                    im.Text("    Add part: ")
                                                    im.SameLine()
                                                    im.InputText("##newPart"..tostring(k), configVals.cobalt.permissions.vehiclePerm[k].partLevelnameInput, 128)
                                                    im.Text("    ")
                                                    im.SameLine()
                            ...
                            if im.TreeNode1("groups:") then
                                    ...
                                    if im.TreeNode1(groupName) then
                                        ...
                                        if config.cobalt.groups[k].groupPerms.level then
                                            if im.TreeNode1("group players:") then
                                                ...
                                                im.Text("        ")
                                                im.SameLine()
                                                im.InputText("##groupPlayerName"..tostring(k), configVals.cobalt.groups[k].groupPerms.newGroupPlayerInput, 128)
                                                im.Text("        ")
                                                im.SameLine()
                                        ...
                                        if config.cobalt.groups[k].groupPerms.banReason then
                                            ...
                                            im.Text("        ")
                                            im.SameLine()
                                            im.InputText("##banReason"..tostring(k), configVals.cobalt.groups[k].groupPerms.groupBanReasonInput, 128)
                                            im.Text("        ")
                                            im.SameLine()
                                            if im.SmallButton("Apply##"..tostring(k)) then
                                        ...
                                        im.Text("        ")
                                        im.SameLine()
                                        im.InputText("##groupPermission"..tostring(k), configVals.cobalt.groups[k].groupPerms.newGroupPermissionInput, 128)
                                        im.Text("        ")
                                        im.SameLine()
                                ...
                                im.Text("        Add Group: ")
                                im.SameLine()
                                im.InputText("##groupName", configVals.cobalt.newGroupInput, 128)
                                im.Indent()
                                im.Indent()
                                im.Indent()
                                im.Text("        ")
                        ...
                        if currentGroup == "owner" or currentGroup == "admin" or currentGroup == "mod" or currentUIPerm >= config.cobalt.interface.config then
                            ...
                            if im.TreeNode1("whitelisted players:") then
                                ...
                                im.Text("        ")
                                im.SameLine()
                                im.InputText("##whitelistName", configVals.cobalt.whitelistNameInput, 128)
                                im.Text("        ")
                                im.SameLine()
                ...
                if currentGroup == "owner" or currentGroup == "admin" or currentUIPerm >= config.cobalt.interface.server then
                    if im.CollapsingHeader1("Server") then
                        ...
                        if im.TreeNode1("name:") then
                            ...
                            im.Text("        ")
                            im.SameLine()
                            im.InputText("##name", configVals.server.nameInput, 128)
                            im.Text("        ")
                            im.SameLine()
                        ...
                        if im.TreeNode1("map:") then
                            ...
                            im.Text("        ")
                            im.SameLine()
                            im.InputText("##map", configVals.server.mapInput, 128)
                            im.Text("        ")
                            im.SameLine()
                ...
                if currentGroup == "owner" or currentGroup == "admin" or currentGroup == "mod" or currentUIPerm >= config.cobalt.interface.nametags then
                    if im.CollapsingHeader1("Nametags") then
                        ...
                        if im.TreeNode1("Nametag Whitelist: ") then
                            ...
                            im.Text("        ")
                            im.SameLine()
                            im.InputText("##whitelistName", configVals.nametags.whitelistNameInput, 128)
                            im.Text("        ")
                            im.SameLine()
...
----------------------------------------------------------------------------------DATABASE TAB
        if currentGroup == "owner" or currentGroup == "admin" or currentUIPerm >= config.cobalt.interface.database then
            if im.BeginTabItem("Database") then
                ...
                im.Text("Reason:")
                im.SameLine()
                im.InputText("##kickBanMuteReason", playersDatabaseVals.kickBanMuteReason, 128)
                im.Text("tempBan:")
                im.SameLine()
                im.PushItemWidth(120*CEIScale[0])
                ...
                for k, player in pairs(playersDatabase) do
                    if type(k) == "number" then
                        local playerName   = player.playerName
                        local playerBeammp = player.beammp
                        if playerName and playerName ~= playerBeammp then
                            if im.ImGuiTextFilter_PassFilter(playersDatabaseFiltering.filter, playerName) then
                                if playerName ~= playerBeammp then
                                    if playerName == playersDatabaseFiltering.lines[k] then
                                        if im.TreeNode1("##"..playerName) then
                                            ...
                                            if player.tempBanRemaining then
                                                im.SameLine()
                                            ...
                                            if currentGroup == "owner" or currentGroup == "admin" or currentUIPerm >= config.cobalt.interface.playerPermissionsPlus then
                                                if player.banned then
                                                    ...
                                                    if player.tempBanRemaining then
                                                        im.Text("    ")
                                                        im.SameLine()
                                                        im.Text("tempBan: " .. tostring(string.format("%.0f",player.tempBanRemaining)) .. " seconds left")
                                                        if not player.banReason then
                                                            im.Text("    ")
                                                            im.SameLine()
                                            ...
                                            if player.banReason then
                                                im.Text("    ")
                                                im.SameLine()
                                                im.Text("banReason: " .. player.banReason)
                                            end
                                            if currentGroup == "owner" or currentGroup == "admin" or currentUIPerm >= config.cobalt.interface.playerPermissions then
                                                if player.permissions then
                                                    im.Text("                  ")
                                                    im.SameLine()
                                                    if player.permissions.muted == false or player.permissions.muted == nil then
                                                    ...
                                                    if player.permissions.whitelisted == false or player.permissions.whitelisted == nil then
                                                        im.SameLine()
                                                    ...
                                                    if im.TreeNode1("permissions##"..playerName) then
                                                        if player.permissions.teleport == false or player.permissions.teleport == nil or player.permissions.teleport == "nil" then
                                                            if im.SmallButton("Allow Teleport##"..playerName) then
                                                                local data = jsonEncode( { playerName, true } )
                                                                TriggerServerEvent("CEISetTeleportPerm", data)
                                                                log('W', logTag, "CEISetTeleportPerm Called: " .. data)
                                                            end
                                                        elseif player.permissions.teleport == true then
                                                        ...
                                                        if currentGroup == "owner" or currentGroup == "admin" or currentUIPerm >= config.cobalt.interface.playerPermissionsPlus then
                                                            if player.permissions.resetExempt == false or player.permissions.resetExempt == nil or player.permissions.resetExempt == "nil" then
                                                                if im.SmallButton("Exempt Reset Bypass##"..tostring(k)) then
                                                                    local data = jsonEncode( { player.playerName, true } )
                                                                    TriggerServerEvent("CEISetResetPerm", data)
                                                                    log('W', logTag, "CEISetResetPerm Called: " .. data)
                                                                end
                                                            elseif player.permissions.resetExempt == true then
                                                                if im.SmallButton("Revoke Reset Bypass##"..tostring(k)) then
                                                                    local data = jsonEncode( { player.playerName, false } )
                                                                    TriggerServerEvent("CEISetResetPerm", data)
                                                                    log('W', logTag, "CEISetResetPerm Called: " .. data)
                                                                end
                                                            end
                                                        ...
                                                        if im.TreeNode1("UI Level:") then
                                                            ...
                                                            if player.permissions.UI then
                                                                im.Text(tostring(player.permissions.UI))
                                                                if currentGroup == "owner" or currentUIPerm >= config.cobalt.interface.interface then
                                                                    im.Text("        ")
                                                                    im.SameLine()
                                                                    im.PushItemWidth(120*CEIScale[0])
                                                                    if im.InputInt("##UILevelDatabase"..tostring(k), playersDatabaseVals[k].permissions.UILevelInt, 1) then
                                                                        local data = jsonEncode( { player.playerName, tostring(playersDatabaseVals[k].permissions.UILevelInt[0]) } )
                                                                        TriggerServerEvent("CEISetTempUIPerm", data)
                                                                        log('W', logTag, "CEISetTempUIPerm Called: " .. data)
                                                                    end
                                                                    im.PopItemWidth()
                                                        ...
                                                        if im.TreeNode1("level:") then
                                                            im.SameLine()
                                                            im.Text(tostring(player.permissions.level))
                                                            im.Text("        ")
                                                            im.SameLine()
                                                            im.PushItemWidth(120*CEIScale[0])
                                                            if im.InputInt("##levelDBPlayer"..tostring(k), playersDatabaseVals[k].permissions.levelInt, 1) then
                                                                local data = jsonEncode( { player.playerName, tostring(playersDatabaseVals[k].permissions.levelInt[0]) } )
                                                                TriggerServerEvent("CEISetTempPerm", data)
                                                                log('W', logTag, "CEISetTempPerm Called: " .. data)
                                                            end
                                                            im.PopItemWidth()
                                                        ...
                                                        im.Text("        whitelisted: " .. tostring(player.permissions.whitelisted))
                                                        im.Text("        muted: " .. tostring(player.permissions.muted))
                                                        im.Text("        muteReason: " .. tostring(player.permissions.muteReason))
                                                        if im.TreeNode1("group:##" .. playerName) then
                                                            if player.permissions.group then
                                                                im.SameLine()
                                                                im.Text(player.permissions.group)
                                                            else
                                                                im.SameLine()
                                                                im.Text("none")
                                                            end
                                                            im.Text("        ")
                                                            im.SameLine()
                                                            im.InputText("##newGroup"..tostring(k), playersDatabaseVals[k].permissions.groupInput, 128)
                                                            im.Text("        ")
                                                            im.SameLine()
                                                            if im.SmallButton("Apply##"..tostring(k)) then
                                                                local data = jsonEncode( { player.playerName, "group:" .. ffi.string(playersDatabaseVals[k].permissions.groupInput) } )
                                                                TriggerServerEvent("CEISetGroup", data)
                                                                log('W', logTag, "CEISetGroup Called: " .. data)
                                                            end
                                                            im.SameLine()
                                                            ...
                                                            im.PushStyleColor2(im.Col_ButtonActive, im.ImVec4(0.95, 0.15, 0.15, 0.888))
                                                            if im.SmallButton("Remove##"..tostring(k)) then
                                                                local data = jsonEncode( { player.playerName, "none" } )
                                                                TriggerServerEvent("CEISetGroup", data)
                                                                log('W', logTag, "CEISetGroup Called: " .. data)
                                                            end
                                                            im.PopStyleColor(3)
